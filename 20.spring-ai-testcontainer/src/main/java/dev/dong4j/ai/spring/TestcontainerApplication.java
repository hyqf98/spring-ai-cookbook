 ...
 *
 * <p>Spring Boot 应用启动类, 用于启动 Testcontainers 应用程序. 该类通过 SpringApplication.run 方法启动 Spring Boot 应用,
 * 初始化相关配置和组件.
 *
...
public class TestcontainerApplication {
     ...
     *
     * <p>该方法通过 SpringApplication 运行 TestcontainerApplication 类, 启动 Testcontainers 应用
     *
     * @param args 启动参数
     */
